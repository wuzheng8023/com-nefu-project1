...
<div id="detail2-box" class="clearfix">
    <div class="tit-80">教师信息</div>
    <div class="tabula-box">
        <div class="max-tit">教师简介</div>
        <ul>
            <li><a href="/introduction">教师甲</a></li>

            <li><a href="/introduction">教师乙</a></li>

            <li><a href="/introduction">教师丙</a></li>

            <li><a href="/introduction">教师丁</a></li>

        </ul>
    </div>

    <div class="content-box">
        <h1 style="color: #0aa6d6">教师照片</h1>
        <ul class="clearfix" style=" width:705px; margin-left:-10px;">
            <li class="pic">
                ...
                <h3><a href="/introduction">教师甲</a></h3>
            </li>
            <li class="pic">
                <div class="img-box">
                     <a href="/introduction" >
                ...
                <h3><a href="/introduction">教师乙</a></h3>
            </li>
            <li class="pic">
                <div class="img-box">
                     <a href="/introduction">
                ...
                <h3><a href="/introduction">教师丙</a></h3>
            </li>
            <li class="pic">
                <div class="img-box">
                    <a href="/introduction">
                ...
                <h3><a href="/introduction">教师丁</a></h3>
            </li>
